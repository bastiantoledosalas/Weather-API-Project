...
let WeatherService = class WeatherService {
    ...
    async getWeather(city) {
        ...
        try {
            ...
            await this.cacheService.set(cacheKey, JSON.stringify(data), 43200);
            return data;
        }
        catch (error) {
            throw new common_1.HttpException('Error fetching weather data', common_1.HttpStatus.BAD_GATEWAY);
        }
    }
};
